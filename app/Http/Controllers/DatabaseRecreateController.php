...
class DatabaseRecreateController extends Controller
{
    ...
    private function seedFreshData()
    {
        ...
        $jobs = [
            ...
            [
                ...
                'description' => 'Great opportunity for design students to gain hands-on experience. You will work on real projects and learn from experienced designers. Portfolio required.',
                'category' => 'Design',
                'city' => 'Marrakech',
