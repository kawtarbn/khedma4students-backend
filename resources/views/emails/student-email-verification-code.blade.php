...
<head>
    <meta charset="utf-8">
    <title>Verify Your Email - Khedma4Students</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p class="message">Hello {{ $student->full_name }},</p>
        <p class="message">Your email verification code is:</p>
        
        <div class="code-box">{{ $verificationCode }}</div>
        
        <a href="{{ config('frontend.url') }}/verify-email?token={{ $token }}&email={{ $student->email }}" class="button">Verify Email</a>
